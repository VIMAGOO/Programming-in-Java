...
public class NIFValidator {
    ...
    /**
     * Checks whether provided value is a valid NIF (Número de Identificación
     * Fiscal).
     *
     * @param value value to be validated.
     * @return true if value is valid, false otherwise.
     ...
     *
     * @param code code to be validated.
     * @return true if code corresponds to a valid NIF code, false otherwise.
     */
    ...
    /**
     * Checks whether provided code corresponds to a valid NIF for minors having
     * less than 14 years old.
     *
     * @param code code to be validated.
     * @return true if code corresponds to a valid NIF for minors having less
     * than 14 years old, false otherwise.
     */
    ...
    /**
     * Gets or creates singleton instance to validate DNI's, NIF's, CIF's, etc
     * using the library provided by the Ministerio de Hacienda.
     *
