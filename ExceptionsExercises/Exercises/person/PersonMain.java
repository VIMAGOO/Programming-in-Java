...
public class PersonMain {
    ...
    public static void main(String args[]) {
        try {
            Person a = new Person("21782670Z", "Peter", 20);
            Person b = new Person("21782670Z", "Peter", 23);
            System.out.println("Valid NIF a?: " + a.isNifValid());
            System.out.println("Valid NIF b?: " + Person.isAValidNif(b.getNif()));
